...
export declare class ReservationController {
    ...
    cancelReservation(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    ...
    deleteReservation(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    deleteRejectedReservations(req: Request, res: Response): Promise<void>;
