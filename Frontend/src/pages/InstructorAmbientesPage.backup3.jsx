    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="bg-gradient-to-r from-sena-600 to-sena-700 p-6 text-white">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                <div className="relative">
                  ...
                  >
                    <option value="">Todos los tipos</option>
                    {[...new Set(ambientes.map(a => a.tipo))].map(tipo => (
        ...
        {filteredAmbientes.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAmbientes.map(ambiente => (
              <div
                key={ambiente._id}
                className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-slate-100 hover:border-slate-200"
                onClick={() => handleAmbienteClick(ambiente)}
              >
                <div className="relative">
                  <div className="h-36 bg-gradient-to-r from-slate-100 to-slate-200 flex items-center justify-center">
                ...
                <div className="p-5">
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-lg font-bold text-slate-800">{ambiente.nombre}</h3>
                      <p className="text-slate-500 text-sm mt-1 flex items-center">
                        <MapPin className="h-3.5 w-3.5 mr-1.5 text-slate-400" />
                        {ambiente.ubicacion}
                      </p>
