...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-neutral-soft-100">
      {/* Header Responsivo */}
      <header className="bg-white/90 backdrop-blur-md border-b border-neutral-soft-200 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3 sm:py-4">
            {/* Logo y título */}
            <div className="flex items-center space-x-2 sm:space-x-4">
              <img src={logoSena} alt="SENA" className="h-8 w-8 sm:h-12 sm:w-12" />
              <div className="hidden sm:block">
                <h1 className="text-xl sm:text-2xl font-bold text-neutral-soft-800">OccupyManager</h1>
                <p className="text-neutral-soft-600 text-xs sm:text-sm">Sistema de Gestión de Ambientes SENA</p>
              </div>
              <div className="sm:hidden">
                <h1 className="text-lg font-bold text-neutral-soft-800">OccupyManager</h1>
              </div>
            </div>
            ...
            <div className="hidden lg:flex space-x-3">
              ...
              <Button 
                ...
                className="text-neutral-soft-700 border-neutral-soft-300 hover:bg-neutral-soft-50 hover:text-neutral-soft-800"
              >
              ...
              <Button 
                onClick={handleLogin}
                className="bg-sena-soft-500 text-white hover:bg-sena-soft-600 shadow-md transition-all duration-200"
              >
                Iniciar Sesión
              </Button>
            </div>
            ...
            <div className="lg:hidden">
              <button
                ...
                className="p-2 rounded-md text-neutral-soft-600 hover:text-neutral-soft-800 hover:bg-neutral-soft-100 transition-colors"
              >
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden border-t border-neutral-soft-200 py-4 space-y-3">
              ...
              <Button 
                variant="outline" 
                onClick={handleContactAdmin}
                className="w-full text-neutral-soft-700 border-neutral-soft-300 hover:bg-neutral-soft-50 hover:text-neutral-soft-800 justify-start"
              >
                <UserCheck className="mr-2 h-4 w-4" />
                Solicitar Acceso
              </Button>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-sena-soft-50 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-soft-800 mb-4 sm:mb-6">
            Gestiona los Ambientes de tu
            <span className="block text-sena-soft-600">Institución SENA</span>
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-neutral-soft-600 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-4">
            OccupyManager es la solución integral para la administración, reserva y 
            monitoreo de ambientes educativos. Optimiza el uso de espacios y mejora 
            la experiencia de instructores y aprendices.
          </p>
          
          {/* Access Options Responsivo */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8 max-w-4xl mx-auto">
            {/* Guest Access for Students */}
            <div className="bg-white/80 backdrop-blur-sm border border-blue-200 rounded-lg p-4 sm:p-6">
              <div className="flex items-center justify-center mb-3">
                <Eye className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 mr-2" />
                <h3 className="text-base sm:text-lg font-semibold text-neutral-soft-800">Acceso para Aprendices</h3>
              </div>
              <p className="text-neutral-soft-600 mb-4 text-xs sm:text-sm">
                Consulta la disponibilidad y horarios de los ambientes de formación 
                sin necesidad de cuenta de usuario.
              </p>
              <Button 
                onClick={handleGuestAccess}
                className="bg-blue-500 text-white hover:bg-blue-600 w-full text-sm sm:text-base"
              >
                <Eye className="mr-2 h-4 w-4" />
            ...
            {/* Account Access */}
            <div className="bg-white/80 backdrop-blur-sm border border-sena-soft-200 rounded-lg p-4 sm:p-6">
              <div className="flex items-center justify-center mb-3">
                <UserCheck className="h-5 w-5 sm:h-6 sm:w-6 text-sena-soft-600 mr-2" />
                <h3 className="text-base sm:text-lg font-semibold text-neutral-soft-800">Acceso con Cuenta</h3>
              </div>
              <p className="text-neutral-soft-600 mb-4 text-xs sm:text-sm">
                Para instructores, guardias y administradores. Las cuentas son 
                creadas únicamente por administradores del sistema.
              </p>
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                <Button 
                  size="sm" 
                  onClick={handleLogin}
                  className="bg-sena-soft-500 text-white hover:bg-sena-soft-600 flex-1 text-sm"
                >
                  Iniciar Sesión
                </Button>
                <Button 
                  ...
                  size="sm"
                  onClick={handleContactAdmin}
                  className="text-sena-soft-600 border-sena-soft-300 hover:bg-sena-soft-50 flex-1 text-sm"
                >
                  Solicitar
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-xl shadow-md hover:shadow-lg p-4 sm:p-6 border border-neutral-soft-200 transition-all duration-200 hover:border-sena-soft-300">
                  ...
                  <p className="text-neutral-soft-600 text-sm sm:text-base">
                    {feature.description}
                  </p>
                </div>
              );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-blue-200">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-neutral-soft-800 mb-2">Aprendiz (Guest)</h4>
              <p className="text-neutral-soft-600 text-xs sm:text-sm mb-3">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-neutral-soft-200">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-neutral-soft-800 mb-2">Administrador</h4>
              <p className="text-neutral-soft-600 text-xs sm:text-sm mb-3">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-neutral-soft-200">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-neutral-soft-800 mb-2">Instructor</h4>
              <p className="text-neutral-soft-600 text-xs sm:text-sm mb-3">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-neutral-soft-200">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-neutral-soft-800 mb-2">Guardia</h4>
              <p className="text-neutral-soft-600 text-xs sm:text-sm mb-3">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-neutral-soft-200 sm:col-span-2 lg:col-span-1">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
                <Users className="h-5 w-5 sm:h-6 sm:w-6 text-purple-600" />
              </div>
              <h4 className="text-base sm:text-lg font-semibold text-neutral-soft-800 mb-2">Aprendiz (Cuenta)</h4>
              <p className="text-neutral-soft-600 text-xs sm:text-sm mb-3">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {!showAccessForm ? (
            <div className="text-center">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-neutral-soft-800 mb-4 sm:mb-6">
                ¿Necesitas Acceso Completo al Sistema?
              </h3>
              <p className="text-base sm:text-lg lg:text-xl text-neutral-soft-700 mb-6 sm:mb-8 px-4">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 sm:p-6 mb-6 sm:mb-8 border border-sena-soft-300">
                <h4 className="text-base sm:text-lg font-semibold text-neutral-soft-800 mb-4">Información Requerida para Solicitar Cuenta:</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-neutral-soft-600 text-xs sm:text-sm">
      ...
      {/* Footer Responsivo */}
      <footer className="bg-neutral-soft-100 text-neutral-soft-800 py-8 sm:py-12 border-t border-neutral-soft-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <img src={logoSena} alt="SENA" className="h-8 w-8 sm:h-10 sm:w-10" />
                <span className="text-lg sm:text-xl font-bold text-neutral-soft-800">OccupyManager</span>
              </div>
              <p className="text-neutral-soft-600 text-sm sm:text-base mb-4">
            ...
            <div>
              <h4 className="text-base sm:text-lg font-semibold mb-4 text-neutral-soft-800">Acceso Rápido</h4>
              <ul className="space-y-2 text-neutral-soft-600 text-sm sm:text-base">
                <li>
                  <button 
                    onClick={handleGuestAccess}
            ...
            <div>
              <h4 className="text-base sm:text-lg font-semibold mb-4 text-neutral-soft-800">Contacto Administrativo</h4>
              <div className="space-y-3 text-neutral-soft-600 text-sm sm:text-base">
          ...
          <div className="border-t border-neutral-soft-300 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-neutral-soft-500 text-xs sm:text-sm">
